                ...
                <div class="profile__user-buttons user__buttons">
                    <?php if(!$is_your_profile): ?>
                        <?php if($is_subscription): ?>
                            <a href="subscription.php?user_id=<?= $user_id ?>&follower_id=<?= $actual_user_id ?>&action=remove" class="profile__user-button user__button user__button--subscription button button--main">Отписаться</a>
                            <a class="profile__user-button user__button user__button--writing button button--green" href="#">Сообщение</a>
                        <?php else: ?>
                            <a href="subscription.php?user_id=<?= $user_id ?>&follower_id=<?= $actual_user_id ?>&action=add" class="profile__user-button user__button user__button--subscription button button--main">Подписаться</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <ul class="profile__tabs-list filters__list tabs__list">
                        ...
                        <li class="profile__tabs-item filters__item">
                            <a href="profile.php?user_id=<?= $user_id ?>&tab=likes"
                                class="profile__tabs-link filters__button tabs__item button">Лайки</a>
                        </li>
                        <li class="profile__tabs-item filters__item">
                            <a href="profile.php?user_id=<?= $user_id ?>&tab=subscriptions"
                               class="profile__tabs-link filters__button tabs__item button">Подписки</a>
                        </li>
                    </ul>
                </div>
                                ...
                                <?php if(!$is_show_comments): ?>
                                    <div class="comments">
                                        <a
                                            ...
                                            href="profile.php?user_id=<?= $user_id ?>&post_id=<?= $post['id'] ?>&show_comments"
                                        ...
                                        <div class="comments">
                                            <div class="comments__list-wrapper">
                                                ...
                                                <?php if($comments_count > 2 && count($comments) <= 2): ?>
                                                    <a
                                                        class="comments__more-link" href="profile.php?user_id=<?= $user_id ?>&post_id=<?= $post['id'] ?>&show_comments&all_comments">
